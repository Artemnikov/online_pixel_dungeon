"""ExitRoom: a StandardRoom that drops STAIRS_DOWN at a random interior cell."""
...
class ExitRoom(StandardRoom):
    ...
    # Don't trap the room the player needs to walk to to descend.
    ...
    def paint(self, level) -> None:
        ...
        level.set_tile(x, y, level.STAIRS_DOWN)
        level.exit = (x, y)
